...
downloadButton.addEventListener("click", () => {
  ...
  let csv = "BPM,Avg_BPM,SensorElapsed_ms,SensorElapsed_s,MeasureElapsed_s,RecvEpoch_ms,RecvISO\n";
  for (const r of receivedData) {
    csv += `${r.bpm},${r.beatAvg},${r.sensor_elapsed_ms},${r.sensor_elapsed_s},${r.measure_elapsed_s},${r.recv_epoch_ms},${r.recv_iso}\n`;
  }
